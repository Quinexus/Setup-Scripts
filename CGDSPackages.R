...
# Clinical Outcome/Drug Discovery
...
# Class discovery and unsupervised learning
check_install("NMF")
check_install("cluster")
check_install("factoextra")
check_install("dendextend")
check_install("ConsensusClusterPlus", source = "Bioconductor")
check_install("pathview", source = "Bioconductor")
check_install("enrichplot", source = "Bioconductor")
check_install("DOSE", source = "Bioconductor")
